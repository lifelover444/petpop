...
> **推荐下载免安装版： [PetPop release petpop.exe](https://raw.githubusercontent.com/lifelover444/petpop/main/downloads/petpop.exe)**
>
> 安装版： [PetPop_0.1.0_x64-setup.exe](https://raw.githubusercontent.com/lifelover444/petpop/main/downloads/PetPop_0.1.0_x64-setup.exe)
>
> MSI 安装包： [PetPop_0.1.0_x64_en-US.msi](https://raw.githubusercontent.com/lifelover444/petpop/main/downloads/PetPop_0.1.0_x64_en-US.msi)
>
> 如果浏览器没有自动下载，请右键链接选择“另存为”。
...
1. 下载 [petpop.exe](https://raw.githubusercontent.com/lifelover444/petpop/main/downloads/petpop.exe)。
2. 双击运行。
3. 启动 PetPop 后，在右侧导入区选择宠物包、扫描 Codex 宠物，或输入 PetDex 宠物网页链接。

如果你希望走安装向导，也可以使用 [PetPop_0.1.0_x64-setup.exe](https://raw.githubusercontent.com/lifelover444/petpop/main/downloads/PetPop_0.1.0_x64-setup.exe)。
...
如果需要更新 README 中的直接下载文件，把这些构建产物同步复制到 `downloads/` 目录后再提交。
